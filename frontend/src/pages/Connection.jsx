...
import {User,UserPlus,UserCheck,UserRoundPen,MessageSquare, Icon} from 'lucide-react'
import { 
        ...
        <div className='inline-flex flex-wrap items-center border border-gray-200 rounded-md p-1 bg-white shadow-sm'>
          {
            dataArray.map((tab)=>(
              ...
              ${currentTab === tab.label ? 'bg-white text-black font-medium' : 'text-gray-500 hover:text-black'}`}>
                ...
                <div className='flex max-sm:flex-col gap-2 mt-4'>
                  ...
                  }
                  {
                    currentTab === 'Connections' && (
                      ...
                      className='w-full p-2 flex items-center justify-center gap-2 text-sm rounded bg-slate-100 hover:bg-slate-200 text-black active:scale-95 transition cursor-pointer'>
                        Message

  ...
  return  (
    <div className='min-h-screen bg-gradient-to-b from-slate-50 to-white'>
      <div className='max-w-6xl mx-auto p-6'>
        ...
        {/* from */}
        <div className='max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-sm space-y-4'>
          ...
          {/* text area  */}
          <textarea
          className='w-full resize-none max-h-20 text-sm mt-4 outline-none placeholder-gray-400'
            ...
            images.length > 0 && <div className='flex flex-wrap gap-2 mt-4'>
              {images.map((image,i)=>(
                <div key={i} className=' relative group'>
                  ...
                  className=' absolute hidden group-hover:flex justify-center items-center top-0 right-0 bottom-0 left-0 bg-black/40 roun-md cursor-pointer'
                  >
          ...
          <div className=' flex items-center justify-between pt-3 border-t border-gray-300'>
            ...
            className='flex itme-center gap-2 text-sm text-gray-500 hover:text-gray-700 transition cursor-pointer'
            >

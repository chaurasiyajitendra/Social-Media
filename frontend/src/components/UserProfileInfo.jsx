        ...
        <div className='flex flex-col md:flex-row items-start gap-6'>
            ...
            <div className='w-full pt-16 md:pt-0 md:pl-36'>
                <div className=' flex flex-col md:flex-row items-start justify-between'>
                    ...
                    {/* if user is not other profile that menas he is opeing his profile so we will give edit button  */}
                    {
                        !profileId &&
                        <button
                        onClick={()=> setShowEdit(true)}
                        className='flex cursor-pointer items-center gap-3 border border-gray-300 hover:bg-gray-50 px-4 py-4 rounded-lg font-medium transition-colors mt-4 md:mt-0' 
                        >

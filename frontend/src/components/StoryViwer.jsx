  ...
  return (
    ...
    {/* progress bar  */}
        <div className=' absolute top-0 left-0 w-full h-1 bg-gray-700'>
            <div 
            className=' h-full transition-all duration-100 bg-white linear'
        ...
        {/* userInfo  */}
        <div className=' absolute flex top-4 left-4 items-center space-x-3 p-2 px-4 sm:p-4 sm:px-8 backdrop-blur-2xl rounded bg-black/50'>
            <img 
        ...
        <button onClick={()=>setViewStory(null)} className=' absolute top-4 right-4 text-white text-3xl font-bold focus:outline-none'>
            <X className='w-8 h-8 hover:scale-110 cursor-pointer transition'/>
        </button>
